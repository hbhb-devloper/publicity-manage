package com.hbhb.cw.publicity.mapper;//package com.hbhb.cw.systemcenter.mapper;
...
public class Generator {
    ...
    private static final String URL = "jdbc:mysql://mariadb.yeexun.com.cn/cw_publicity";
    private static final String USERNAME = "zhcw";
    private static final String PASSWORD = "zhcw@2020";
    /**
     * 数据库表名
     */
    private static final String TABLE_NAME = "application_detail";
