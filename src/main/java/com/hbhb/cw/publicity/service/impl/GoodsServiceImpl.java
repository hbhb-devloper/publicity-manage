...
public class GoodsServiceImpl implements GoodsService {
    ...
    public void applyGoods(List<ApplicationVO> list, GoodsReqVO goodsReqVO) {
        ...
        // 得到id
        List<Application> applicationList = applicationMapper.selectByCond(date, goodsReqVO.getHallId());
    ...
    @Override
    public List<SummaryGoodsVO> getSimplexList(GoodsReqVO goodsReqVO) {
        return getSummaryList(goodsReqVO, GoodsType.BUSINESS_SIMPLEX.getValue());
    }

    @Override
    public List<SummaryGoodsVO> getSingleList(GoodsReqVO goodsReqVO) {
        return getSummaryList(goodsReqVO, GoodsType.FLYER_PAGE.getValue());
    }

    @Override
    public List<SummaryGoodsVO> getAuditSimplexList(GoodsReqVO goodsReqVO, Integer state) {
        // todo state需要字典 枚举
    ...
    @Override
    public List<SummaryGoodsVO> getAuditSingleList(GoodsReqVO goodsReqVO, Integer state) {
        // todo state需要字典 枚举
        state = state == null ? 0 : state;
    ...
    @Override
    public void saveGoods(List<Long> list) {
    ...
    @Override
    public List<SummaryUnitGoodsVO> getUnitGoodsList(GoodsReqVO goodsReqVO) {
        // 通过时间与截止时间，判断为几月第几次。
     ...
     * 获取分公司汇总（审核）
     */
    private List<SummaryGoodsVO> getSummaryList(GoodsReqVO goodsReqVO, Integer type, Integer state){
